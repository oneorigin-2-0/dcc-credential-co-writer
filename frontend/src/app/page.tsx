...
import { Loader2, Paperclip, X, FileText, Edit, Save, ChevronDown, ChevronUp, Settings } from 'lucide-react';
...
export default function Home() {
  ...
  const [isPrivacyModalOpen, setIsPrivacyModalOpen] = useReactState(false);
    ...
    <main id="main-content" className="bg-gray-50 min-h-screen">
      <div className="container mx-auto p-4 md:p-8">
        <div className="flex justify-center">
          <div className={`w-full max-w-6xl transition-all duration-700 ${isVisible
            ...
            <FormProvider {...form}>
              <Card className="border-0 shadow-xl bg-white">
                <CardHeader>
                  <h1 className="text-3xl font-headline font-black text-center">
                    Craft Your Recognition
                  </h1>
                  <CardDescription className="text-lg text-gray-600 leading-relaxed">
                    Upload or attach your course content to instantly build Open Badges 3.0 content.
                    <br></br>
                    Example course content can include syllabi, learning objectives, course outlines and summaries.
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent className="px-8 pb-8">
                  <form onSubmit={e => e.preventDefault()}>
                          ...
                          <FormControl>
                            <div className="relative mb-4">
                              <Textarea
                                ...
                                placeholder="Enter your course content to generate an Open Badges 3.0 credential template."
                    ...
                    {/* Disclaimer Checkbox + Privacy policy link */}
                    <div className="mt-6 p-4 border rounded-lg">
                      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                        ...
                        <button
                          ...
                          className="self-start text-xs sm:text-sm text-secondary underline hover:text-primary"
                        >
                          Privacy Policy
                        </button>
                      </div>
